      ...
      {links.map((link) => (
        <li key={link.href} className="inline-block">
          <a
            ...
            href={link.href}
            className="block py-2 px-2 m-2 max-xs:m-1 font-normal no-underline text-inherit rounded-lg transition-all duration-200 hover:text-primary hover:bg-accent"
          >
            {link.label}
          </a>
        </li>
